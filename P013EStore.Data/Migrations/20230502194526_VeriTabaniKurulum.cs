    ...
    public partial class VeriTabaniKurulum : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreateDate", "Email", "IsAdmin", "Isactive", "Name", "Password", "Phone", "Surname", "UserGuid", "UserName" },
                values: new object[] { 1, new DateTime(2023, 5, 2, 22, 45, 26, 600, DateTimeKind.Local).AddTicks(8076), "info@P013EStore.com", true, true, "Admin", "123", null, null, new Guid("295f1a3f-4511-46d1-9554-b0761b0aa122"), "Admin" });
